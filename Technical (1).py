...
training_image_set = trainset_datagenerator.flow_from_directory(r'product/training',
                                                 target_size=(128,128),
                                                 batch_size =n_batch,
                                                 class_mode = 'binary')

testing_image_set = testset_datagenerator.flow_from_directory(r'product/test',
                                            target_size=(128,128),
                                            batch_size =n_batch,
                                            class_mode = 'binary')
